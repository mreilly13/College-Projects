...
class JClassDeclaration extends JAST implements JTypeDecl {
    ...
    public void codegen(CLEmitter output) {
        ...
        String qualifiedName = JAST.compilationUnit.packageName() == "" ?
                name : JAST.compilationUnit.packageName() + "/" + name;
        // Generate an ArrayList of Strings for the superInterfaces.
        ArrayList<String> superInterfacesStrings = null;
        if (superInterfaces != null) {
            superInterfacesStrings = new ArrayList<String>();
            for (TypeName superInterface : superInterfaces) {
                superInterfacesStrings.add(superInterface.jvmName());
            }
        }
        output.addClass(mods, qualifiedName, superType.jvmName(), superInterfacesStrings, false);
